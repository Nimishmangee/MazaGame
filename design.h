        ...
        void drawFloor(float x, float y){
            /*for(int i = 0; i< col; i++){
                for(int j = 0; j< row; j++){
                    ...
                    glBegin(GL_QUADS);
                    //glNormal3f(0,1,0);
                    glTexCoord2f(30,0);glVertex3i(0,0,0);//lower left vertex

                    //glNormal3f(0,1,0);
                    glTexCoord2f(0,0);glVertex3i(0,0,j*size_y);//lower right vertex

                    //glNormal3f(0,1,0);
                    glTexCoord2f(0,30);glVertex3i(i*size_x,0,j*size_y);//upper right vertex

                    //glNormal3f(0,1,0);
                    glTexCoord2f(30,30);glVertex3i(i*size_x,0,0);//top left vertex
                    glEnd();
                    glDisable(GL_TEXTURE_2D);
                }
            }*/
            ...
            glBegin(GL_QUADS);
            glTexCoord2f(30,0);glVertex3i(0,0,0);//lower left vertex
            glTexCoord2f(0,0);glVertex3i(0,0,y);//lower right vertex
            glTexCoord2f(0,30);glVertex3i(x,0,y);//upper right vertex
            glTexCoord2f(30,30);glVertex3i(x,0,0);//upper left vertex
            glEnd();
            glDisable(GL_TEXTURE_2D);
        }
};
...
class Tank{     
    public:       
        ...
        void shoot(int len){
            ...
            len > 3 ? len = 3 : len=len;//maximum shooting distance 3
            //as we rotate the plane, we just have to increase x
            if(direction == LEFT){
